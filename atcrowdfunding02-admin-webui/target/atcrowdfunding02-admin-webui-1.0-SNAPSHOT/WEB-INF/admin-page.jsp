        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <%--</button>--%>
                    <a href="admin/delete.html" class="btn btn-danger" style="float: right; margin-left: 10px;"><i class=" glyphicon glyphicon-remove"></i> 删除</a>
                    <!--
                    旧代码
                                ...
                                <c:forEach items="${requestScope.pageInfo.list }" var="admin" varStatus="myStatus">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <%--remove button--%>
                                            <a href="admin/delete.html?id=${admin.id }&pageNum=${requestScope.pageInfo.pageNum }&keyword=${param.keyword }" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </c:if>
